...
const MyContacts = ({ data }) => (
  <Layout>
    ...
    <div class="text-center">
      ...
      >
        <p>
          Kevin built the MyContacts app as a Free app. This SERVICE is provided
          by Kevin at no cost and is intended for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at MyContacts unless
        ...
        <p>
          ...
          but not limited to name,phone,email,image. The information that I
        ...
        <p>
          ...
          not hesitate to contact me at [App Contact informations].
        </p>{" "}
        <p>
